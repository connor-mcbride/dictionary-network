...
\begin{figure}[!htbp]
\begin{center}
    \includegraphics[scale=0.5]{power_law.png}
\end{center}
    \caption{Power law curve fit to degrees histogram.}
    \label{fig:power_law}
\end{figure}
